    ...
    <form className={`z-50 w-[400px] absolute right-0 -top-32 bg-darkest-grey p-6 ${isCollapsed ? 'h-[73px] overflow-y-hidden' : 'h-auto overflow-y-visible'} rounded-lg`} onSubmit={onSubmit}>
      <header>
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold text-white uppercase font-montserrat">Adicionar Jogo</h1>
          <button
            type="button"
      ...
      <div className="mb-4 relative">
        <div className="relative flex flex-col gap-2">
          <label className="font-monomaniac-one text-lightest-grey tracking-widest">Qual jogo?</label>
          <input
            type="text"
